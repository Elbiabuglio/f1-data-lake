...
Utilizei a biblioteca [FastF1](https://docs.fastf1.dev/) como fonte de dados, a partir de scripts em Python para realizar a coleta das informações históricas.
